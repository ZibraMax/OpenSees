...
int TclModelBuilderElementCommand(ClientData clientData, Tcl_Interp *interp,
                                  ...
                                  Domain *theTclDomain, TclModelBuilder *theTclBuilder)
{
  ...
  else if ((strcmp(argv[1], "TFPbearing") == 0) || (strcmp(argv[1], "TFP") == 0) || (strcmp(argv[1], "TPFbearing") == 0) || (strcmp(argv[1], "TPF") == 0))
  {
  ...
  else if (strcmp(argv[1], "MVLEM_3D") == 0)
  { // Kristijan Kolozvari
  ...
  else if (strcmp(argv[1], "SFI_MVLEM_3D") == 0)
  { // Kristijan Kolozvari
  ...
  else if (strcmp(argv[1], "E_SFI_MVLEM_3D") == 0)
  { // Kristijan Kolozvari
  ...
  else if ((strcmp(argv[1], "shellDKGQ") == 0) || (strcmp(argv[1], "ShellDKGQ") == 0))
  { // Lisha Wang & Xinzheng Lu
  ...
  else if ((strcmp(argv[1], "shellNLDKGQ") == 0) || (strcmp(argv[1], "ShellNLDKGQ") == 0))
  { // Lisha Wang & Xinzheng Lu
  ...
  else if ((strcmp(argv[1], "Quad4FiberOverlay") == 0))
  { //////////////////////// mmc
  ...
  else if ((strcmp(argv[1], "Brick8FiberOverlay") == 0))
  { //////////////////////// mmc
  ...
  else if ((strcmp(argv[1], "QuadBeamEmbedContact") == 0))
  { //////////////////////// mmc
  ...
  else if (strcmp(argv[1], "elastomericBearing") == 0 || (strcmp(argv[1], "elastomericBearingPlasticity")) == 0)
  {
    Element *theEle = 0;
    if (OPS_GetNDM() == 2)
  ...
  else if (strcmp(argv[1], "elastomericBearingBoucWen") == 0 || (strcmp(argv[1], "elastomericBearingBW")) == 0)
  {
    Element *theEle = 0;
    if (OPS_GetNDM() == 2)
  ...
  else if (strcmp(argv[1], "singleFPBearing") == 0 || (strcmp(argv[1], "SFPBearing")) == 0 || (strcmp(argv[1], "singlePFBearing")) == 0 || (strcmp(argv[1], "SPFBearing")) == 0)
  {
    Element *theEle = 0;
    if (OPS_GetNDM() == 2)
  ...
  else if (strcmp(argv[1], "RJWatsonEqsBearing") == 0 || strcmp(argv[1], "RJWatsonBearing") == 0 || strcmp(argv[1], "EQSBearing") == 0)
  {
    Element *theEle = 0;
    if (OPS_GetNDM() == 2)
  ...
  else if ((strcmp(argv[1], "nineNodeMixedQuad") == 0) || (strcmp(argv[1], "nineNodeQuad") == 0))
  {
                                           ...
                                           TclModelBuilder *theTclBuilder)
{
  ...
  else
  {
    ...
    for (int i = 6; i <= (argc - 1); i++)
    {
      ...
      if (strcmp(argv[i], "-mat") == 0 && (i + 1) <= (argc - 1))
      { // -mat matTag?
      ...
      else if (strcmp(argv[i], "-nMat") == 0 && (i + nSpring) <= (argc - 1))
      { // -mat matTag?
      ...
      else if (strcmp(argv[i], "-orient") == 0 && (i + 6) <= (argc - 1) && Tcl_GetDouble(interp, argv[i + 4], &value) == TCL_OK)
                                            ...
                                            TclModelBuilder *theTclBuilder)
{
  ...
  if (argc < 6)
  { // element multipleNormalSpring eleTag? iNode? jNode? nDivide?
  ...
  else
  {
    ...
    for (int i = 6; i <= (argc - 1); i++)
    {
      ...
      else if (strcmp(argv[i], "-shape") == 0 && (i + 1) <= (argc - 1))
      { // -shape shape?
      ...
      else if (strcmp(argv[i], "-size") == 0 && (i + 1) <= (argc - 1))
      { // -size size?
      ...
      else if (strcmp(argv[i], "-lambda") == 0 && (i + 1) <= (argc - 1))
      { // <-lambda lambda?>
                                      ...
                                      TclModelBuilder *theTclBuilder)
{
  ...
  else
  {
    ...
    for (int i = 5; i <= (argc - 1); i++)
    {
      ...
      if (strcmp(argv[i], "-shape") == 0 && (i + 1) <= (argc - 1))
      { // -shape shape?
      ...
      else if (strcmp(argv[i], "-limDisp") == 0 && (i + 1) <= (argc - 1))
      { // <-limDisp limDisp?>
      ...
      else if (strcmp(argv[i], "-nMNS") == 0 && (i + 1) <= (argc - 1))
      { // -nMNS nMNS?
      ...
      else if (strcmp(argv[i], "-matMNS") == 0 && (i + 1) <= (argc - 1))
      { // -matMNS matMNSTag?
      ...
      else if (strcmp(argv[i], "-adjustPDOutput") == 0 && (i + 2) <= (argc - 1))
      ...
      else if (strcmp(argv[i], "-doBalance") == 0 && (i + 3) <= (argc - 1))
                                          ...
                                          TclModelBuilder *theTclBuilder)
{
  ...
  else
  {
    ...
    for (int i = 9; i <= (argc - 1); i++)
    {
      ...
      if (strcmp(argv[i], "-orient") == 0 && (i + 6) <= (argc - 1) && Tcl_GetDouble(interp, argv[i + 4], &value) == TCL_OK)
      { // <-orient x1? x2? x3? yp1? yp2? yp3?>
...
int TclModelBuilder_addWheelRail(ClientData clientData, Tcl_Interp *interp, int argc,
