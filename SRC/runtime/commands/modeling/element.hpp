...
Tcl_CmdProc TclCommand_addOriHinge;
...
const static std::unordered_map<std::string, Tcl_CmdProc *, CaseInsensitive, CaseInsensitive>
    element_dispatch_tcl = {
        ...
        {"OriHinge", TclCommand_addOriHinge},
        //
        // Plane
        //
...
static std::unordered_map<std::string, OPS_Routine *, CaseInsensitive, CaseInsensitive>
    element_dispatch = {
        // Truss
